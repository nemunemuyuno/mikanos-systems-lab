...
//取得済みのメモリマップを1行ずつCSVっぽい文字列にして、memmap ファイルへ書き出している関数
...
EFI_STATUS EFIAPI UefiMain(
  ...
  /*ELF仕様では、kernel.elf の先頭には Elf64_Ehdr の形式でFile Headerがある
と決まっているのでこのアドレスから始まるバイト列を Elf64_Ehdr として読もうってこと*/
